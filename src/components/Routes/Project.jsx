  ...
  const listProjects = [
    {
      ...
      funct: ["Display the Searched Profile and Trending Profile","Show Date and time","Conditional Rendering"]
     }
    ,
    {
      id: 2,
      ...
      funct:["Time tacking dashboard","Login with user details stored in localstorage","User can store client details and track time."]
    },
    {
      id: 3,
      name: "Lyst.com",
      ...
      funct:["Login Authentication using API","Sorting functionality based on price","Payment and checkout Page"]
    },
    {
      id: 4,
      name: "StyleCraze.com",
