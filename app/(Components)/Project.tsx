...
export default function ProjectsSection() {
  return (
    <section
      id="projects"
      className="w-full bg-gradient-to-br from-slate-50 to-blue-50 py-16 md:py-24 lg:py-32 dark:from-slate-950 dark:to-slate-900"
      aria-labelledby="projects-heading"
    >
      <div className="container mx-auto flex flex-col items-center justify-center space-y-12 px-4 md:px-6">
        <div className="max-w-3xl space-y-6 text-center">
          <div className="inline-flex items-center gap-2 rounded-full bg-blue-100 px-4 py-2 text-sm font-medium text-blue-700 dark:bg-blue-950 dark:text-blue-200">
            <Zap className="h-4 w-4" />
            Featured Work
          </div>
          <h2
            id="projects-heading"
            className="bg-gradient-to-r from-gray-900 to-gray-600 bg-clip-text text-4xl font-bold tracking-tight text-transparent md:text-5xl dark:from-gray-100 dark:to-gray-400"
          >
            My Projects
          </h2>
